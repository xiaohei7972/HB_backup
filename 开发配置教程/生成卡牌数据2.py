...
TAG_CARD_SET = {
    ...
    TAG_CARD_SET_ENUM.THE_LOST_CITY: "1952-安戈洛龟途",
    TAG_CARD_SET_ENUM.PET: "1961-宠物",
    TAG_CARD_SET_ENUM.TIME_TRAVEL: "1957-穿越时间流",
}
...
# 各文件路径
file_cardIDEnumPath = f"{os.getcwd()}\\..\\Routines\\DefaultRoutine\\Silverfish\\ai\\CardDB_cardIDEnum.cs"
file_cardNameCNPath = f"{os.getcwd()}\\..\\Routines\\DefaultRoutine\\Silverfish\\ai\\CardDB_cardNameCN.cs"
file_cardNameENPath = f"{os.getcwd()}\\..\\Routines\\DefaultRoutine\\Silverfish\\ai\\CardDB_cardNameEN.cs"
file_simOldRootPath = f"{os.getcwd()}\\..\\Routines\\DefaultRoutine\\Silverfish\\cards\\"
        ...
        if cardSet not in TAG_CARD_SET:
            ...
            if cardType not in TAG_CARDTYPE or \
                ...
                if cardType == TAG_CARDTYPE_ENUM.ENCHANTMENT:  # 附魔
                    ...
                    sim_data = ""
                    directory = f"{file_simNewRootPath}{TAG_CARD_SET[cardSet]}\\ENCHANTMENT"
