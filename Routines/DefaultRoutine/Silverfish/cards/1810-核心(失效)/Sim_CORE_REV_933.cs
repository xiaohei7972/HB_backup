...
namespace HREngine.Bots
{
	...
	class Sim_CORE_REV_933 : SimTemplate
	{
		// CardDB.Card weapon = CardDB.Instance.getCardDataFromID(CardDB.cardIDEnum.CORE_REV_933);
		...
		{
			// 检查己方英雄是否装备了“灌能战斧”
			if (own.own && p.ownWeapon.card.cardIDenum == CardDB.cardIDEnum.CORE_REV_933)
			{
