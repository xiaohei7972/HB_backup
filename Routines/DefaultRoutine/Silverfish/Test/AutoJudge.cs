...
namespace HREngine.Bots
{
    public class AutoJudge : TestBase
    {
        ...
        private static string mainPath = Path.Combine(
            Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location),
            "Routines", "DefaultRoutine", "Silverfish") + Path.DirectorySeparatorChar;
        private static string testPath = Path.Combine("Test", "Data", "单卡测试", "护园森灵") + Path.DirectorySeparatorChar; // 需要测试的文件夹
